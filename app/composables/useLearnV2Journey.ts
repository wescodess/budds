...
export function useLearnV2Journey(learningVoidId?: MaybeRef<string | null | undefined>) {
  ...
  return { allowed, checkingAccess, hub, mission, snapshot, sources, objectives, readiness, plan, busy, error, generation, generationIsActive, canResearch, researching, researchResults, defaultSchedule, planInput, saveOutcomeDraft, createMission, startMapGeneration, editLearningMap, prepareAndAcceptSource, rejectSource, addUrlSource, researchPublicSources, acceptLearningMap, submitCalibrationAttempt, completeCalibration, createPlanPreview, editPlanPreview, acceptPlan }
}
