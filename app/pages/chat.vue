...
<template>
  <div class="flex flex-1 flex-col overflow-hidden">
    ...
    <div ref="scrollRef" role="log" aria-live="polite" class="flex-1 overflow-y-auto p-4">
      ...
      <div class="mx-auto max-w-3xl space-y-4">
        <div
          ...
          :class="[
            ...
            msg.role === 'user' ? 'ml-auto max-w-[85%] bg-muted' : 'mr-auto border border-border bg-card',
          ]"
        >
          {{ msg.content }}
        </div>
    ...
    <form class="border-t border-border p-4" @submit.prevent="handleSend(query)">
