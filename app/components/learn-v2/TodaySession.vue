...
type Feedback = {
  ...
  replayed?: boolean
  feedback?: { criterionResults: Array<{ key: string, label: string, awarded: boolean, message: string }>, misconceptionFeedback: Array<{ tag: string, message: string }> }
}
