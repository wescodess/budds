...
export interface LearnSourceSnapshot { id: string; title: string; origin: LearnSourceOrigin; publisher?: string; retrievedLabel: string; coverage: LearnCoverage; lifecycle: LearnSourceLifecycle; objectives: string[]; accessNote?: string; excerpt?: string }
