...
export default defineSchema({
  ...
  learnBlueprintRevisions: defineTable({ userId: v.string(), blueprintId: v.id('learnBlueprints'), learningVoidId: v.id('learningVoids'), revision: v.number(), recordRevision: v.number(), status: v.union(v.literal('draft'), v.literal('source_review'), v.literal('map_review'), v.literal('accepted'), v.literal('active'), v.literal('superseded')), acceptedAt: v.optional(v.number()), createdAt: v.number(), updatedAt: v.number() }).index('by_userId', ['userId']).index('by_userId_and_blueprintId_and_revision', ['userId', 'blueprintId', 'revision']).index('by_userId_and_learningVoidId', ['userId', 'learningVoidId']).index('by_userId_and_learningVoidId_and_status', ['userId', 'learningVoidId', 'status']),
  learnMilestones: defineTable({ userId: v.string(), blueprintRevisionId: v.id('learnBlueprintRevisions'), order: v.number(), title: v.string() }).index('by_userId', ['userId']).index('by_userId_and_blueprintRevisionId_and_order', ['userId', 'blueprintRevisionId', 'order']),
  learnObjectives: defineTable({ userId: v.string(), blueprintRevisionId: v.id('learnBlueprintRevisions'), order: v.number(), title: v.string(), assessmentContract: v.optional(v.string()) }).index('by_userId', ['userId']).index('by_userId_and_blueprintRevisionId_and_order', ['userId', 'blueprintRevisionId', 'order']),
  ...
  learnSourceIdentities: defineTable({ userId: v.string(), learningVoidId: v.id('learningVoids'), origin: v.union(v.literal('folder_document'), v.literal('user_url'), v.literal('open_database'), v.literal('general_web_search')), externalKey: v.string(), folderDocumentId: v.optional(v.id('documents')), title: v.optional(v.string()) }).index('by_userId', ['userId']).index('by_userId_and_learningVoidId', ['userId', 'learningVoidId']).index('by_userId_and_origin_and_externalKey', ['userId', 'origin', 'externalKey']).index('by_userId_and_folderDocumentId', ['userId', 'folderDocumentId']).index('by_userId_and_learningVoidId_and_folderDocumentId', ['userId', 'learningVoidId', 'folderDocumentId']),
  learnSourceSnapshots: defineTable({ userId: v.string(), sourceIdentityId: v.id('learnSourceIdentities'), learningVoidId: v.id('learningVoids'), blueprintRevisionId: v.optional(v.id('learnBlueprintRevisions')), folderManifestId: v.optional(v.id('learnFolderSourceManifests')), revision: v.number(), status: v.union(v.literal('candidate'), v.literal('fetched'), v.literal('evaluated'), v.literal('user_accepted'), v.literal('rejected'), v.literal('unavailable')), contentHash: v.optional(v.string()), sourceRevision: v.optional(v.string()), objectKey: v.optional(v.string()), folderId: v.optional(v.id('folders')), folderRevision: v.optional(v.string()), filename: v.optional(v.string()), evidencePurgedAt: v.optional(v.number()), createdAt: v.number() }).index('by_userId', ['userId']).index('by_userId_and_sourceIdentityId_and_revision', ['userId', 'sourceIdentityId', 'revision']).index('by_userId_and_sourceIdentityId_and_evidencePurgedAt', ['userId', 'sourceIdentityId', 'evidencePurgedAt']).index('by_userId_and_learningVoidId_and_status', ['userId', 'learningVoidId', 'status']).index('by_userId_and_blueprintRevisionId', ['userId', 'blueprintRevisionId']).index('by_userId_and_folderManifestId', ['userId', 'folderManifestId']),
  learnSourceExcerpts: defineTable({ userId: v.string(), sourceSnapshotId: v.id('learnSourceSnapshots'), locator: v.string(), privateLocator: v.optional(v.string()), excerpt: v.optional(v.string()), rightsStatus: v.union(v.literal('permitted'), v.literal('unknown'), v.literal('prohibited')), evidencePurgedAt: v.optional(v.number()) }).index('by_userId', ['userId']).index('by_userId_and_sourceSnapshotId', ['userId', 'sourceSnapshotId']).index('by_userId_and_sourceSnapshotId_and_evidencePurgedAt', ['userId', 'sourceSnapshotId', 'evidencePurgedAt']),
  learnObjectiveSources: defineTable({ userId: v.string(), objectiveId: v.id('learnObjectives'), sourceSnapshotId: v.id('learnSourceSnapshots'), coverage: v.union(v.literal('strong'), v.literal('partial'), v.literal('gap')) }).index('by_userId', ['userId']).index('by_userId_and_objectiveId_and_sourceSnapshotId', ['userId', 'objectiveId', 'sourceSnapshotId']),
  learnClaimSupports: defineTable({ userId: v.string(), sessionContentClaimId: v.id('sessionContentClaims'), sourceExcerptId: v.id('learnSourceExcerpts'), entailment: v.union(v.literal('entailed'), v.literal('not_entailed'), v.literal('not_evaluated')), conflictStatus: v.union(v.literal('clear'), v.literal('unresolved')), evidenceStatus: v.optional(v.union(v.literal('evidence_available'), v.literal('evidence_unavailable'))) }).index('by_userId', ['userId']).index('by_userId_and_sessionContentClaimId', ['userId', 'sessionContentClaimId']).index('by_userId_and_sourceExcerptId', ['userId', 'sourceExcerptId']).index('by_userId_and_sourceExcerptId_and_evidenceStatus', ['userId', 'sourceExcerptId', 'evidenceStatus']),
  masteryAttempts: defineTable({ userId: v.string(), objectiveId: v.id('learnObjectives'), attemptedAt: v.number(), idempotencyKey: v.string(), result: v.optional(v.string()) }).index('by_userId', ['userId']).index('by_userId_and_objectiveId_and_attemptedAt', ['userId', 'objectiveId', 'attemptedAt']).index('by_userId_and_idempotencyKey', ['userId', 'idempotencyKey']),
  masteryRecords: defineTable({ userId: v.string(), objectiveId: v.id('learnObjectives'), state: v.union(v.literal('unseen'), v.literal('learning'), v.literal('guided'), v.literal('independent'), v.literal('retained'), v.literal('needs_review'), v.literal('blocked'), v.literal('provisionally_known')), nextReviewAt: v.optional(v.number()) }).index('by_userId', ['userId']).index('by_userId_and_objectiveId', ['userId', 'objectiveId']).index('by_userId_and_nextReviewAt', ['userId', 'nextReviewAt']),
  studyPlans: defineTable({ userId: v.string(), learningVoidId: v.id('learningVoids'), revision: v.number(), createdAt: v.number() }).index('by_userId', ['userId']).index('by_userId_and_learningVoidId', ['userId', 'learningVoidId']),
  studyPlanRevisions: defineTable({ userId: v.string(), studyPlanId: v.id('studyPlans'), learningVoidId: v.id('learningVoids'), revision: v.number(), status: v.union(v.literal('draft'), v.literal('accepted'), v.literal('active'), v.literal('superseded')), createdAt: v.number() }).index('by_userId', ['userId']).index('by_userId_and_studyPlanId_and_revision', ['userId', 'studyPlanId', 'revision']).index('by_userId_and_learningVoidId_and_status', ['userId', 'learningVoidId', 'status']),
  studySessions: defineTable({ userId: v.string(), studyPlanRevisionId: v.id('studyPlanRevisions'), primaryObjectiveId: v.id('learnObjectives'), status: v.union(v.literal('planned'), v.literal('ready'), v.literal('in_progress'), v.literal('completed'), v.literal('missed'), v.literal('cancelled'), v.literal('blocked'), v.literal('generation_failed'), v.literal('needs_reschedule')), revision: v.number(), scheduledStartAt: v.number() }).index('by_userId', ['userId']).index('by_userId_and_studyPlanRevisionId_and_scheduledStartAt', ['userId', 'studyPlanRevisionId', 'scheduledStartAt']).index('by_userId_and_status_and_scheduledStartAt', ['userId', 'status', 'scheduledStartAt']),
  ...
  sessionContent: defineTable({ userId: v.string(), studySessionId: v.id('studySessions'), revision: v.number(), status: v.union(v.literal('draft'), v.literal('ready'), v.literal('published'), v.literal('superseded')), createdAt: v.number() }).index('by_userId', ['userId']).index('by_userId_and_studySessionId_and_revision', ['userId', 'studySessionId', 'revision']).index('by_userId_and_status', ['userId', 'status']),
  sessionContentBlocks: defineTable({ userId: v.string(), sessionContentId: v.id('sessionContent'), order: v.number(), kind: v.string() }).index('by_userId', ['userId']).index('by_userId_and_sessionContentId_and_order', ['userId', 'sessionContentId', 'order']),
  sessionContentClaims: defineTable({ userId: v.string(), sessionContentId: v.id('sessionContent'), order: v.number(), claim: v.string() }).index('by_userId', ['userId']).index('by_userId_and_sessionContentId_and_order', ['userId', 'sessionContentId', 'order']),
  ...
  learnFolderSourceManifestFolders: defineTable({ userId: v.string(), manifestId: v.id('learnFolderSourceManifests'), folderId: v.id('folders'), parentFolderId: v.optional(v.id('folders')), name: v.string(), folderRevision: v.string(), depth: v.number(), order: v.number(), stage: v.union(v.literal('children'), v.literal('documents'), v.literal('complete')), childCursor: v.optional(v.string()), documentCursor: v.optional(v.string()), documentCount: v.number() }).index('by_userId', ['userId']).index('by_userId_and_manifestId_and_folderId', ['userId', 'manifestId', 'folderId']).index('by_userId_and_manifestId_and_stage_and_order', ['userId', 'manifestId', 'stage', 'order']).index('by_userId_and_manifestId_and_order', ['userId', 'manifestId', 'order']),
  learnFolderSourceManifestEntries: defineTable({ userId: v.string(), manifestId: v.id('learnFolderSourceManifests'), order: v.number(), documentId: v.id('documents'), folderId: v.id('folders'), folderRevision: v.string(), sourceIdentityId: v.id('learnSourceIdentities'), sourceSnapshotId: v.id('learnSourceSnapshots'), contentHash: v.optional(v.string()), documentRevision: v.optional(v.string()), availability: v.union(v.literal('available'), v.literal('unavailable')), unavailableReason: v.optional(v.union(v.literal('processing'), v.literal('failed'), v.literal('missing_object_key'), v.literal('invalid_content_hash'), v.literal('invalid_source_revision'))) }).index('by_userId', ['userId']).index('by_userId_and_manifestId_and_order', ['userId', 'manifestId', 'order']).index('by_userId_and_manifestId_and_documentId', ['userId', 'manifestId', 'documentId']),
