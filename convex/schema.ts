...
export default defineSchema({
  users: defineTable({
    ...
    audioOverviewQuota: v.optional(
      v.object({
        date: v.string(),
        count: v.number(),
      }),
    ),
    audioOverviewInterjectionQuota: v.optional(
      v.object({
        date: v.string(),
        count: v.number(),
      }),
    ),
    learnV2Entitlement: v.optional(
      v.object({
        enabled: v.boolean(),
        updatedAt: v.number(),
      }),
  ...
  folders: defineTable({
    ...
    preferredMainPane: v.optional(
      v.union(v.literal("chat"), v.literal("podcast")),
    ),
    referenceScope: v.optional(
      v.object({
  ...
  documents: defineTable({
    ...
    sourceType: v.optional(
      v.union(v.literal("file"), v.literal("website"), v.literal("youtube")),
    ),
    ...
    .index("by_userId_and_folderId_and_status", [
      "userId",
      "folderId",
      "status",
    ])
  ...
  messages: defineTable({
    ...
    interjectionContext: v.optional(
      v.object({
  ...
  quizzes: defineTable({
    ...
    creationMethod: v.optional(
      v.union(v.literal("manual"), v.literal("auto_generated")),
    ),
    difficulty: v.optional(v.string()),
    language: v.optional(v.string()),
    questionCount: v.optional(v.number()),
    latestAttemptStatus: v.optional(
      v.union(
  ...
  tasks: defineTable({
    ...
    updatedAt: v.number(),
    completedAt: v.optional(v.number()),
    audioOverviewRequest: v.optional(
      v.object({
  ...
  audioOverviewClaimSources: defineTable({
    ...
    .index("by_claimRecordId_and_manifestEntryId", [
      "claimRecordId",
      "manifestEntryId",
    ])
  ...
  audioOverviewUtteranceSources: defineTable({
    ...
    .index("by_utteranceId_and_manifestEntryId", [
      "utteranceId",
      "manifestEntryId",
    ])
  ...
  audioOverviewAlignmentSegments: defineTable({
    ...
    .index("by_alignmentId_and_utteranceId_and_wordIndex", [
      "alignmentId",
      "utteranceId",
      "wordIndex",
    ])
  ...
  audioOverviewInterjectionsV2: defineTable({
    ...
    .index("by_episodeId", ["episodeId"])
    .index("by_userId_and_audioOverviewId_and_idempotencyKey", [
      "userId",
      "audioOverviewId",
      "idempotencyKey",
    ])
  ...
  audioOverviewInterjectionUtterances: defineTable({
    ...
    evidenceQuotes: v.optional(
      v.array(v.object({ sourceId: v.string(), quote: v.string() })),
    ),
    verificationUtteranceId: v.optional(v.string()),
    verificationVersion: v.optional(v.literal("claim-entailment.v1")),
    verificationModel: v.optional(v.string()),
  ...
  calendarEvents: defineTable({
    ...
    .index("by_courseId", ["courseId"])
    .index("by_userId_and_status", ["userId", "status"])
    .index("by_userId_and_status_and_scheduledAt", [
      "userId",
      "status",
      "scheduledAt",
    ])
    .index("by_calendarConnectionId_and_calendarEventId", [
  ...
  calendarEventCleanupJobs: defineTable({
    ...
    .index("by_calendarConnectionId_and_status", [
      "calendarConnectionId",
      "status",
    ])
    .index("by_calendarConnectionId_and_calendarEventId", [
    ...
    .index("by_calendarConnectionId_and_operationKey", [
      "calendarConnectionId",
      "operationKey",
    ])
    .index("by_calendarConnectionId_and_courseId_and_reason", [
      "calendarConnectionId",
      "courseId",
      "reason",
    ])
  ...
  pendingCleanup: defineTable({
    ...
    .index("by_userId_and_attempts_and_nextAttemptAt", [
      "userId",
      "attempts",
      "nextAttemptAt",
    ])
    ...
    .index("by_kind_and_attempts_and_nextAttemptAt", [
      "kind",
      "attempts",
      "nextAttemptAt",
    ]),
  ...
  learningVoids: defineTable({
    ...
    revision: v.number(),
    activeBlueprintRevisionId: v.optional(v.id("learnBlueprintRevisions")),
  ...
  learnBlueprintRevisions: defineTable({
    userId: v.string(),
    blueprintId: v.id("learnBlueprints"),
    learningVoidId: v.id("learningVoids"),
    revision: v.number(),
    ...
    intentVersion: v.optional(v.literal("learn-v2.blueprint-intent.v1")),
    ...
    desiredDepth: v.optional(
      v.union(v.literal("overview"), v.literal("working"), v.literal("deep")),
    ),
    sourcePolicy: v.optional(
      v.union(
        v.literal("folder_only"),
        v.literal("folder_plus_web"),
        v.literal("web_only"),
      ),
    ),
    generationInputDigest: v.optional(v.string()),
    generationSupportingSourceSnapshotIds: v.optional(
      v.array(v.id("learnSourceSnapshots")),
    ),
    generatorVersion: v.optional(v.string()),
    generationProvider: v.optional(
      v.literal("openrouter_via_cloudflare_ai_gateway"),
    ),
    ...
    .index("by_userId", ["userId"])
    .index("by_userId_and_blueprintId_and_revision", [
      "userId",
      "blueprintId",
      "revision",
    ])
    .index("by_userId_and_learningVoidId", ["userId", "learningVoidId"])
    .index("by_userId_and_learningVoidId_and_status", [
      "userId",
      "learningVoidId",
      "status",
    ]),
  learnMilestones: defineTable({
    userId: v.string(),
    ...
    .index("by_userId", ["userId"])
    .index("by_userId_and_blueprintRevisionId_and_order", [
      "userId",
      "blueprintRevisionId",
      "order",
    ]),
  learnObjectives: defineTable({
    userId: v.string(),
    blueprintRevisionId: v.id("learnBlueprintRevisions"),
    milestoneId: v.optional(v.id("learnMilestones")),
    order: v.number(),
    title: v.string(),
    capability: v.optional(v.string()),
    estimatedMinutes: v.optional(v.number()),
    coverage: v.optional(
      v.union(v.literal("strong"), v.literal("partial"), v.literal("gap")),
    ),
    gapReason: v.optional(v.string()),
    assessmentContract: v.optional(
      v.union(
        v.string(),
        v.object({
    ...
    .index("by_userId_and_milestoneId_and_order", [
      "userId",
      "milestoneId",
      "order",
    ]),
  learnObjectivePrerequisites: defineTable({
    userId: v.string(),
    blueprintRevisionId: v.id("learnBlueprintRevisions"),
    ...
    .index("by_userId", ["userId"])
    .index("by_userId_and_blueprintRevisionId_and_objectiveId", [
      "userId",
      "blueprintRevisionId",
      "objectiveId",
    ])
    .index("by_userId_and_prerequisiteObjectiveId", [
      "userId",
      "prerequisiteObjectiveId",
    ]),
  learnSourceIdentities: defineTable({
    userId: v.string(),
    learningVoidId: v.id("learningVoids"),
    origin: v.union(
      v.literal("folder_document"),
      v.literal("user_url"),
      v.literal("open_database"),
      v.literal("general_web_search"),
    ),
    externalKey: v.string(),
    canonicalUrl: v.optional(v.string()),
    publicLocator: v.optional(v.string()),
    privateLocator: v.optional(v.string()),
    folderDocumentId: v.optional(v.id("documents")),
    title: v.optional(v.string()),
    tombstonedAt: v.optional(v.number()),
  })
    .index("by_userId", ["userId"])
    .index("by_userId_and_learningVoidId", ["userId", "learningVoidId"])
    .index("by_userId_and_origin_and_externalKey", [
      "userId",
      "origin",
      "externalKey",
    ])
    .index("by_userId_and_learningVoidId_and_origin_and_externalKey", [
      "userId",
      "learningVoidId",
      "origin",
      "externalKey",
    ])
    .index("by_userId_and_folderDocumentId", ["userId", "folderDocumentId"])
    .index("by_userId_and_learningVoidId_and_folderDocumentId", [
      "userId",
      "learningVoidId",
      "folderDocumentId",
    ]),
  learnSourceSnapshots: defineTable({
    userId: v.string(),
    sourceIdentityId: v.id("learnSourceIdentities"),
    learningVoidId: v.id("learningVoids"),
    blueprintRevisionId: v.optional(v.id("learnBlueprintRevisions")),
    folderManifestId: v.optional(v.id("learnFolderSourceManifests")),
    revision: v.number(),
    ...
    objectKey: v.optional(v.string()),
    folderId: v.optional(v.id("folders")),
    folderRevision: v.optional(v.string()),
    ...
    rightsProvenance: v.optional(
      v.union(
        v.literal("noarchive"),
        v.literal("link_license"),
        v.literal("html_license"),
        v.literal("none"),
      ),
    ),
    rightsPolicyVersion: v.optional(v.string()),
    fetchPolicyVersion: v.optional(v.string()),
    conflictStatus: v.optional(
      v.union(v.literal("clear"), v.literal("unresolved")),
    ),
    trustClassification: v.optional(v.literal("untrusted_source_data")),
    ...
    .index("by_userId", ["userId"])
    .index("by_userId_and_sourceIdentityId_and_revision", [
      "userId",
      "sourceIdentityId",
      "revision",
    ])
    ...
    .index("by_userId_and_learningVoidId_and_effectiveStatus", [
      "userId",
      "learningVoidId",
      "effectiveStatus",
    ])
    .index(
      "by_userId_and_learningVoidId_and_effectiveStatus_and_evidencePurgedAt",
      ["userId", "learningVoidId", "effectiveStatus", "evidencePurgedAt"],
    )
    .index(
      "by_userId_and_learningVoidId_and_effectiveStatus_and_status_and_evidencePurgedAt",
      [
        "userId",
        "learningVoidId",
        "effectiveStatus",
    ...
    .index("by_userId_and_blueprintRevisionId", [
      "userId",
      "blueprintRevisionId",
    ])
    .index("by_userId_and_blueprintRevisionId_and_status", [
      "userId",
      "blueprintRevisionId",
      "status",
    ])
    .index("by_userId_and_blueprintRevisionId_and_effectiveStatus", [
      "userId",
      "blueprintRevisionId",
      "effectiveStatus",
    ])
    .index("by_userId_and_blueprintRevisionId_and_effectiveStatus_and_status", [
      "userId",
      "blueprintRevisionId",
      "effectiveStatus",
      "status",
    ])
    .index("by_userId_and_folderManifestId", ["userId", "folderManifestId"]),
  learnSourceExcerpts: defineTable({
    userId: v.string(),
    ...
    .index("by_userId", ["userId"])
    .index("by_userId_and_sourceSnapshotId", ["userId", "sourceSnapshotId"])
    .index("by_userId_and_sourceSnapshotId_and_evidencePurgedAt", [
      "userId",
      "sourceSnapshotId",
      "evidencePurgedAt",
    ]),
  learnSourceFetchLeases: defineTable({
    userId: v.string(),
    learningVoidId: v.id("learningVoids"),
    sourceSnapshotId: v.id("learnSourceSnapshots"),
    ...
    .index("by_expiresAt", ["expiresAt"])
    .index("by_userId_and_sourceSnapshotId_and_expiresAt", [
      "userId",
      "sourceSnapshotId",
      "expiresAt",
    ])
    .index("by_userId_and_idempotencyKeyHash", [
      "userId",
      "idempotencyKeyHash",
    ]),
  learnSourceFetchRateEvents: defineTable({
    userId: v.string(),
    learningVoidId: v.id("learningVoids"),
    sourceSnapshotId: v.id("learnSourceSnapshots"),
    createdAt: v.number(),
    ...
    .index("by_userId_and_expiresAt", ["userId", "expiresAt"])
    .index("by_expiresAt", ["expiresAt"]),
  learnSourceCommandReceipts: defineTable({
    userId: v.string(),
    learningVoidId: v.id("learningVoids"),
    sourceSnapshotId: v.id("learnSourceSnapshots"),
    idempotencyKeyHash: v.string(),
    ...
    .index("by_userId_and_sourceSnapshotId", ["userId", "sourceSnapshotId"])
    .index("by_userId_and_learningVoidId", ["userId", "learningVoidId"]),
  learnObjectiveSources: defineTable({
    userId: v.string(),
    objectiveId: v.id("learnObjectives"),
    sourceSnapshotId: v.id("learnSourceSnapshots"),
    coverage: v.union(
    ...
    .index("by_userId", ["userId"])
    .index("by_userId_and_objectiveId_and_sourceSnapshotId", [
      "userId",
      "objectiveId",
      "sourceSnapshotId",
    ])
    .index("by_userId_and_sourceSnapshotId", ["userId", "sourceSnapshotId"]),
  learnClaimSupports: defineTable({
    userId: v.string(),
    sessionContentClaimId: v.id("sessionContentClaims"),
    sourceExcerptId: v.id("learnSourceExcerpts"),
    sourceSnapshotId: v.optional(v.id("learnSourceSnapshots")),
    entailment: v.union(
      v.literal("entailed"),
      v.literal("not_entailed"),
      v.literal("not_evaluated"),
    ),
    verifierVersion: v.optional(v.string()),
    confidence: v.optional(v.number()),
    conflictStatus: v.union(v.literal("clear"), v.literal("unresolved")),
    evidenceStatus: v.optional(
      v.union(
        v.literal("evidence_available"),
        v.literal("evidence_unavailable"),
      ),
    ),
  })
    .index("by_userId", ["userId"])
    .index("by_userId_and_sessionContentClaimId", [
      "userId",
      "sessionContentClaimId",
    ])
    .index("by_userId_and_sourceExcerptId", ["userId", "sourceExcerptId"])
    .index("by_userId_and_sourceExcerptId_and_evidenceStatus", [
      "userId",
      "sourceExcerptId",
      "evidenceStatus",
    ]),
  masteryAttempts: defineTable({
    userId: v.string(),
    blueprintRevisionId: v.optional(v.id("learnBlueprintRevisions")),
    objectiveId: v.id("learnObjectives"),
    kind: v.optional(v.literal("calibration")),
    attemptedAt: v.number(),
    idempotencyKey: v.string(),
    requestFingerprint: v.optional(v.string()),
    serverScorePercent: v.optional(v.number()),
    usedHint: v.optional(v.boolean()),
    usedReveal: v.optional(v.boolean()),
    confidence: v.optional(v.number()),
    ...
    .index("by_userId_and_blueprintRevisionId_and_kind", [
      "userId",
      "blueprintRevisionId",
      "kind",
    ])
    .index("by_userId_and_objectiveId_and_attemptedAt", [
      "userId",
      "objectiveId",
      "attemptedAt",
    ])
    .index("by_userId_and_idempotencyKey", ["userId", "idempotencyKey"]),
  masteryRecords: defineTable({
    userId: v.string(),
    blueprintRevisionId: v.optional(v.id("learnBlueprintRevisions")),
    objectiveId: v.id("learnObjectives"),
    state: v.union(
      ...
      v.literal("blocked"),
      v.literal("provisionally_known"),
    ),
    schedulingPriority: v.optional(
      v.union(
    ...
    recordRevision: v.optional(v.number()),
    firstIndependentPassAt: v.optional(v.number()),
    ...
    .index("by_userId_and_objectiveId", ["userId", "objectiveId"])
    .index("by_userId_and_nextReviewAt", ["userId", "nextReviewAt"]),
  studyPlans: defineTable({
    userId: v.string(),
    learningVoidId: v.id("learningVoids"),
    revision: v.number(),
    activeRevisionId: v.optional(v.id("studyPlanRevisions")),
    createdAt: v.number(),
    updatedAt: v.optional(v.number()),
  })
    .index("by_userId", ["userId"])
    .index("by_userId_and_learningVoidId", ["userId", "learningVoidId"]),
  studyPlanRevisions: defineTable({
    userId: v.string(),
    ...
    parentRevisionId: v.optional(v.id("studyPlanRevisions")),
    changeReason: v.optional(
      v.union(
        v.literal("availability_changed"),
        v.literal("deadline_changed"),
        v.literal("session_length_changed"),
        v.literal("future_incomplete_reflow"),
      ),
    ),
    blueprintRevisionId: v.optional(v.id("learnBlueprintRevisions")),
    blueprintRecordRevision: v.optional(v.number()),
    schedulerVersion: v.optional(v.string()),
    timezone: v.optional(v.string()),
    inputSnapshot: v.optional(v.string()),
    resultSnapshot: v.optional(v.string()),
    feasibility: v.optional(
      v.union(v.literal("feasible"), v.literal("infeasible")),
    ),
    createdAt: v.number(),
    acceptedAt: v.optional(v.number()),
    updatedAt: v.optional(v.number()),
    ...
    .index("by_userId", ["userId"])
    .index("by_userId_and_studyPlanId_and_revision", [
      "userId",
      "studyPlanId",
      "revision",
    ])
    .index("by_userId_and_studyPlanId_and_feasibility_and_revision", [
      "userId",
      "studyPlanId",
      "feasibility",
      "revision",
  ...
  studySessions: defineTable({
    ...
    placementKind: v.optional(
      v.union(
        v.literal("learning"),
        v.literal("review"),
        v.literal("retained_review"),
      ),
    ),
    schedulingPriority: v.optional(v.string()),
    schedulerVersion: v.optional(v.string()),
    startedSessionContentRevision: v.optional(v.number()),
    missedAt: v.optional(v.number()),
    auditReasonCode: v.optional(v.string()),
  })
    .index("by_userId", ["userId"])
    .index("by_userId_and_studyPlanRevisionId_and_scheduledStartAt", [
      "userId",
      "studyPlanRevisionId",
      "scheduledStartAt",
    ])
    .index("by_userId_and_status_and_scheduledStartAt", [
      "userId",
      "status",
      "scheduledStartAt",
    ]),
  learnPlanCommandReceipts: defineTable({
    userId: v.string(),
    learningVoidId: v.id("learningVoids"),
    idempotencyKey: v.string(),
    command: v.string(),
    ...
    .index("by_userId_and_idempotencyKey", ["userId", "idempotencyKey"])
    .index("by_userId_and_learningVoidId", ["userId", "learningVoidId"]),
  learnPlanAuditEvents: defineTable({
    userId: v.string(),
    learningVoidId: v.id("learningVoids"),
    studyPlanRevisionId: v.optional(v.id("studyPlanRevisions")),
    studySessionId: v.optional(v.id("studySessions")),
    reasonCode: v.string(),
    details: v.string(),
    createdAt: v.number(),
  })
    .index("by_userId", ["userId"])
    .index("by_userId_and_learningVoidId", ["userId", "learningVoidId"])
    .index("by_userId_and_studyPlanRevisionId", [
      "userId",
      "studyPlanRevisionId",
    ]),
  studySessionRetrievalObjectives: defineTable({
    userId: v.string(),
    ...
    .index("by_userId", ["userId"])
    .index("by_userId_and_studySessionId_and_order", [
      "userId",
      "studySessionId",
      "order",
    ]),
  sessionContent: defineTable({
    userId: v.string(),
    studySessionId: v.id("studySessions"),
    studyPlanRevisionId: v.optional(v.id("studyPlanRevisions")),
    blueprintRevisionId: v.optional(v.id("learnBlueprintRevisions")),
    ...
    assessmentRubricSnapshot: v.optional(v.string()),
    generatorVersion: v.optional(v.string()),
    createdAt: v.number(),
    publishedAt: v.optional(v.number()),
  })
    .index("by_userId", ["userId"])
    .index("by_userId_and_studySessionId_and_revision", [
      "userId",
      "studySessionId",
      "revision",
    ])
    .index("by_userId_and_status", ["userId", "status"]),
  sessionContentBlocks: defineTable({
    userId: v.string(),
    sessionContentId: v.id("sessionContent"),
    order: v.number(),
    kind: v.string(),
    content: v.optional(v.string()),
    claimOrdersJson: v.optional(v.string()),
  })
    .index("by_userId", ["userId"])
    .index("by_userId_and_sessionContentId_and_order", [
      "userId",
      "sessionContentId",
      "order",
    ]),
  sessionContentClaims: defineTable({
    userId: v.string(),
    sessionContentId: v.id("sessionContent"),
    order: v.number(),
    claim: v.string(),
  ...
  calendarProjections: defineTable({
    userId: v.string(),
    studySessionId: v.id("studySessions"),
    status: v.literal("pending_projection"),
    provider: v.optional(v.string()),
    externalEventId: v.optional(v.string()),
  })
    .index("by_userId", ["userId"])
    .index("by_userId_and_studySessionId", ["userId", "studySessionId"])
    .index("by_userId_and_provider_and_externalEventId", [
      "userId",
      "provider",
      "externalEventId",
    ]),
  reminderPolicies: defineTable({
    userId: v.string(),
    learningVoidId: v.id("learningVoids"),
    timezone: v.string(),
    channel: v.string(),
  ...
  searchQuotaBuckets: defineTable({
    ...
    scopeKind: v.union(
      v.literal("product_month"),
      v.literal("product_day"),
      v.literal("user_day"),
      v.literal("learning_void_broad"),
    ),
    scopeKey: v.string(),
    periodKey: v.string(),
    limit: v.number(),
    ...
    circuitReason: v.optional(
      v.union(
        v.literal("usage_policy"),
        v.literal("usage_drift"),
    ...
    .index("by_userId", ["userId"])
    .index("by_provider_and_scopeKind_and_scopeKey_and_periodKey", [
      "provider",
      "scopeKind",
      "scopeKey",
      "periodKey",
    ])
    .index("by_userId_and_provider_and_periodKey", [
      "userId",
      "provider",
      "periodKey",
    ])
    .index("by_userId_and_learningVoidId_and_periodKey", [
      "userId",
      "learningVoidId",
      "periodKey",
    ])
    .index("by_provider_and_reconciliationStatus_and_periodKey", [
      "provider",
  ...
  searchReservations: defineTable({
    ...
    .index("by_userId_and_idempotencyKeyHash", ["userId", "idempotencyKeyHash"])
    .index("by_userId_and_learningVoidId", ["userId", "learningVoidId"])
    .index("by_userId_and_status_and_dispatchState", [
      "userId",
      "status",
      "dispatchState",
    ])
    .index("by_provider_and_status_and_dispatchState_and_expiresAt", [
      "provider",
      "status",
      "dispatchState",
      "expiresAt",
    ])
    .index("by_provider_and_reconciliationRequired_and_updatedAt", [
      "provider",
      "reconciliationRequired",
      "updatedAt",
    ]),
  learnJobs: defineTable({
    userId: v.string(),
    learningVoidId: v.id("learningVoids"),
    blueprintRevisionId: v.optional(v.id("learnBlueprintRevisions")),
    studyPlanRevisionId: v.optional(v.id("studyPlanRevisions")),
    ...
    inputDigest: v.optional(v.string()),
    candidateDigest: v.optional(v.string()),
    expectedVoidRevision: v.optional(v.number()),
    expectedBlueprintRecordRevision: v.optional(v.number()),
    expectedSessionRevision: v.optional(v.number()),
    attempts: v.optional(v.number()),
    providerEnabled: v.optional(v.boolean()),
    providerModel: v.optional(v.string()),
    providerPolicyVersion: v.optional(v.string()),
    providerResponseId: v.optional(v.string()),
    providerResponseModel: v.optional(v.string()),
    dispatchSupportingSourceSnapshotIds: v.optional(
      v.array(v.id("learnSourceSnapshots")),
    ),
    leaseToken: v.optional(v.string()),
    leaseExpiresAt: v.optional(v.number()),
    ...
    .index("by_userId", ["userId"])
    .index("by_userId_and_idempotencyKey", ["userId", "idempotencyKey"])
    .index("by_userId_and_status_and_leaseExpiresAt", [
      "userId",
      "status",
      "leaseExpiresAt",
    ])
    .index("by_status_and_leaseExpiresAt", ["status", "leaseExpiresAt"])
    .index("by_type_and_status_and_leaseExpiresAt", [
      "type",
      "status",
      "leaseExpiresAt",
    ])
    .index("by_userId_and_learningVoidId_and_type", [
      "userId",
      "learningVoidId",
      "type",
    ])
    .index("by_userId_and_blueprintRevisionId_and_type_and_status", [
      "userId",
      "blueprintRevisionId",
      "type",
      "status",
    ...
    .index(
      "by_userId_and_blueprintRevisionId_and_type_and_status_and_terminalReason",
      ["userId", "blueprintRevisionId", "type", "status", "terminalReason"],
    )
    .index("by_userId_and_studySessionId_and_type_and_status", [
      "userId",
      "studySessionId",
      "type",
      "status",
  ...
  learnLifecycleReceipts: defineTable({
    userId: v.string(),
    learningVoidId: v.id("learningVoids"),
    idempotencyKey: v.string(),
    command: v.string(),
    ...
    blueprintRevisionId: v.optional(v.id("learnBlueprintRevisions")),
    blueprintRevisionOrdinal: v.optional(v.number()),
    blueprintRecordRevision: v.optional(v.number()),
    createdAt: v.number(),
  })
    .index("by_userId", ["userId"])
  ...
  learnFolderSourceManifests: defineTable({
    userId: v.string(),
    learningVoidId: v.id("learningVoids"),
    blueprintRevisionId: v.id("learnBlueprintRevisions"),
    ...
    idempotencyKey: v.string(),
    requestFingerprint: v.string(),
    explicitDocumentIds: v.array(v.id("documents")),
    explicitDocumentCursor: v.number(),
    nextFolderOrder: v.number(),
    nextEntryOrder: v.number(),
    entryCount: v.number(),
  ...
  learnFolderSourceManifestFolders: defineTable({
    userId: v.string(),
    manifestId: v.id("learnFolderSourceManifests"),
    folderId: v.optional(v.id("folders")),
    parentFolderId: v.optional(v.id("folders")),
    name: v.optional(v.string()),
    folderRevision: v.string(),
    depth: v.number(),
    order: v.number(),
    stage: v.union(
      v.literal("children"),
    ...
    documentCursor: v.optional(v.string()),
    documentCount: v.number(),
    evidencePurgedAt: v.optional(v.number()),
  })
    .index("by_userId", ["userId"])
    .index("by_userId_and_manifestId_and_folderId", [
      "userId",
      "manifestId",
      "folderId",
    ])
    .index("by_userId_and_manifestId_and_stage_and_order", [
      "userId",
      "manifestId",
      "stage",
      "order",
    ])
    .index("by_userId_and_manifestId_and_order", [
      "userId",
      "manifestId",
      "order",
    ])
    .index("by_userId_and_folderId_and_evidencePurgedAt", [
      "userId",
      "folderId",
      "evidencePurgedAt",
    ]),
  learnFolderSourceManifestEntries: defineTable({
    userId: v.string(),
    manifestId: v.id("learnFolderSourceManifests"),
    order: v.number(),
    documentId: v.optional(v.id("documents")),
    ...
    sourceSnapshotId: v.id("learnSourceSnapshots"),
    contentHash: v.optional(v.string()),
    documentRevision: v.optional(v.string()),
    availability: v.union(v.literal("available"), v.literal("unavailable")),
    unavailableReason: v.optional(
      v.union(
        v.literal("processing"),
        v.literal("failed"),
        v.literal("missing_object_key"),
        v.literal("invalid_content_hash"),
        v.literal("invalid_source_revision"),
        v.literal("source_deleted"),
        v.literal("access_lost"),
    ...
    .index("by_userId_and_manifestId_and_documentId", [
      "userId",
      "manifestId",
      "documentId",
    ])
