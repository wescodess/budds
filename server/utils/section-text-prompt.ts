...
const KNOWLEDGE_TYPE_INSTRUCTIONS: Record<string, string> = {
  ...
  conceptual: `Explain the underlying principles and mental models. Use analogies and comparisons to build intuition. Connect ideas to broader themes. Explain WHY things work the way they do, not just WHAT they are.`,
  procedural: `Provide a clear step-by-step walkthrough. Number each step. Explain what happens at each stage and why. Include common pitfalls and how to avoid them. Use concrete examples to illustrate the process.`,
  mixed: `Blend factual definitions with conceptual explanations. Start with key terms, then explain relationships between concepts. Include practical examples that tie facts to understanding.`,
}
