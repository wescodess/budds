import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { computed, hasInjectionContext, inject, toRef, isRef, watch, nextTick, getCurrentInstance, defineAsyncComponent, defineComponent, h, unref, shallowRef, provide, shallowReactive, ref, Suspense, Fragment, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, withCtx, isReadonly, useSSRContext, isShallow, isReactive, toRaw } from 'vue';
import { m as createError$1, p as parseURL, n as encodePath, o as decodePath, q as hasProtocol, t as isScriptProtocol, v as joinURL, w as withQuery, x as getRequestURL, y as sanitizeStatusCode, z as getRequestHeaders, $ as $fetch$1, A as defu, B as defu$1, C as toRouteMatcher, D as createRouter$1 } from '../nitro/nitro.mjs';
...
const __nuxt_page_meta$1 = { layout: false, auth: "guest" };
...
const _routes = [
  {
    ...
    path: "/app/chat",
    meta: { "auth": "user" },
    component: () => import('./chat-CYiT-mcU.mjs')
  },
  {
    name: "app",
    path: "/app",
    meta: { "auth": "user" },
    component: () => import('./index-C24tSWoO.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: { ...__nuxt_page_meta$1 || {}, ...{ "auth": "guest" } },
    component: () => import('./login-DHaxa18U.mjs')
  },
  {
    name: "index",
    path: "/",
    meta: __nuxt_page_meta || {},
    component: () => import('./index-BrVfd3ht.mjs')
  }
];
...
async function getAuthRouteRules() {
  if (!authRouteRulesPromise) {
    authRouteRulesPromise = import('./virtual_nuxt__Users_wesleyukadike_Desktop_budds_node_modules_.cache_nuxt_.nuxt_better-auth_route-rules-nmvSlHts.mjs').then((mod) => mod.authRouteRules || {}).catch(() => ({}));
  }
...
const session_server_pTtwSWdjKhBBYIwvdejD1WfEPmJPl7lWjexVoNQ_oFU = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  ...
  plugin,
  session_server_pTtwSWdjKhBBYIwvdejD1WfEPmJPl7lWjexVoNQ_oFU,
  revive_payload_server_O8KCmmlUyK2LwHhRwpSm2N0vKxcITeaPrq86bWkSNJs,
  components_plugin_4kY4pyzJIYX99vmMAAIorFf3CnAaptHitJgf7JxiED8
];
const layouts = {
  default: defineAsyncComponent(() => import('./default-NBhViapc.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BoGxOatf.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-5T_xnQOk.mjs'));
...
export { _export_sfc as _, asyncDataDefaults as a, useUserSession as b, createError as c, useRequestEvent as d, entry_default as default, useRoute as e, useRouter as f, encodeRoutePath as g, useRuntimeConfig as h, nuxtLinkDefaults as i, navigateTo as n, resolveRouteObject as r, useNuxtApp as u };
