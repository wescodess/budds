...
export const LEARN_V2_CONTRACT: LearnV2Contract = {
  ...
  persistence: {
    ...
    tables: [
      ...
      table('masteryRecords', 'Derived objective mastery and scheduling-priority projection.', 'derived_projection', [index('userId', 'blueprintRevisionId'), index('userId', 'blueprintRevisionId', 'objectiveId'), index('userId', 'objectiveId'), index('userId', 'nextReviewAt')], 'objectiveId'),
