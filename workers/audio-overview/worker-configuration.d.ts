/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 52e2a3966c298c73c0cb15baf7d15d19)
...
interface __BaseEnv_Env {
	...
	AUDIO_OVERVIEW_WORKFLOW: Workflow<Parameters<import("./src/index").AudioOverviewWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUDIO_OVERVIEW_WORKER_TOKEN">> {}
}
